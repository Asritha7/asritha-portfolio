...
const study = PROJECTS.find((p) => p.slug === "kafka-strimzi-upgrade")!;
const url = "https://asritha.dev/work/kafka-strimzi-upgrade";

export const Route = createFileRoute("/work/kafka-strimzi-upgrade")({
  head: () => ({
    meta: [
