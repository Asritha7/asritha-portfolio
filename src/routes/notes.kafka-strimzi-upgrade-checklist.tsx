...
const SLUG = "validating-kafka-strimzi-upgrades";
const URL = "https://asritha.dev/notes/kafka-strimzi-upgrade-checklist";

export const Route = createFileRoute("/notes/kafka-strimzi-upgrade-checklist")({
  head: () => {
